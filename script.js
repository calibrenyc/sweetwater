  ...
  en: [
    {
      ...
      items: [
        ...
        {
          title: "Mofonguitos (3)",
          price: "Chicken $14 / Beef $16 / Pork Chicharrón $16 / Shrimp $18",
          description: "mini mashed plantain cups filled with your choice of chicken, beef, pork chicharrón, or shrimp",
        },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Dominican-Style Pork Chicharrón", price: "$20", description: "crispy Dominican-style pork chicharrón seasoned and fried untill golden" },
        { title: "Sweetwater Wrap", price: "$14", description: "grilled chicken wrap with lettuce, tomato, and house sauce" },
        { title: "Fish Fellet", price: "$22", description: "fish fillet in garlic and white wine sauce served with vegetables" },
      ],
    },
  ],
  es: [
    {
      ...
      items: [
        ...
        {
          title: "Mofonguitos (3)",
          price: "Pollo $14 / Res $16 / Chicharrón $16/ Camaron $18",
          description: "mini canastas de platano majado rellenas con su eleccion de pollo, res, chicharrón, o camaron",
        },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Chicharrón de Cerdo", price: "$20", description: "chicharrón de cerdo al estilo dominicano, bien crujiente y dorado" },
        { title: "Wrap Sweetwater", price: "$14", description: "wrap de pollo a la parrilla con lechuga, tomate y salsa de la casa" },
        { title: "Filete de Pescado", price: "$22", description: "filete de pescado en salsa de ajo y vino blanco servido con vegetales" }, 
      ],
    },
  ],
};
